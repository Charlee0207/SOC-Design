...
extern "C"
void caravel_ps_hw_stub_wrapper(hls::sim::Byte<8>*, void*, void*, void*, hls::sim::Byte<8>*, hls::sim::Byte<8>*);

extern "C"
void apatb_caravel_ps_hw(hls::sim::Byte<8>* __xlx_apatb_param_ps_mprj_in, void* __xlx_apatb_param_ps_mprj_out, void* __xlx_apatb_param_ps_mprj_en, void* __xlx_apatb_param_mprj_in, hls::sim::Byte<8>* __xlx_apatb_param_mprj_out, hls::sim::Byte<8>* __xlx_apatb_param_mprj_en)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_ps_mprj_in),
#endif
  };
  port0.param = __xlx_apatb_param_ps_mprj_in;

  static hls::sim::Register port1 {
    .name = "ps_mprj_out",
    .width = 38,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_ps_mprj_out),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_ps_mprj_out),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_ps_mprj_out),
#endif
  };
  port1.param = __xlx_apatb_param_ps_mprj_out;

  static hls::sim::Register port2 {
    .name = "ps_mprj_en",
    .width = 38,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_ps_mprj_en),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_ps_mprj_en),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_ps_mprj_en),
#endif
  };
  port2.param = __xlx_apatb_param_ps_mprj_en;

  static hls::sim::Register port3 {
    .name = "mprj_in",
    .width = 38,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_mprj_in),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_mprj_in),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_mprj_in),
#endif
  };
  port3.param = __xlx_apatb_param_mprj_in;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_mprj_out),
#endif
  };
  port4.param = __xlx_apatb_param_mprj_out;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_mprj_en),
#endif
  };
  port5.param = __xlx_apatb_param_mprj_en;
