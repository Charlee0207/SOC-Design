...
extern "C"
void output_pin_hw_stub_wrapper(hls::sim::Byte<1>, void*);

extern "C"
void apatb_output_pin_hw(hls::sim::Byte<1> __xlx_apatb_param_outpin_ctrl, void* __xlx_apatb_param_outpin)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_outpin_ctrl),
#endif
  };
  port0.param = &__xlx_apatb_param_outpin_ctrl;

  static hls::sim::Register port1 {
    .name = "outpin",
    .width = 1,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_outpin),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_outpin),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_outpin),
#endif
  };
  port1.param = __xlx_apatb_param_outpin;
