...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2", "EstimateLatencyMax" : "2059",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.BUS0_m_axi_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	read_romcode {
		BUS0 {Type I LastRead 10 FirstWrite -1}
		romcode {Type I LastRead 0 FirstWrite -1}
		internal_bram {Type O LastRead -1 FirstWrite 11}
		length_r {Type I LastRead 0 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "2059"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "2060"}
]}
