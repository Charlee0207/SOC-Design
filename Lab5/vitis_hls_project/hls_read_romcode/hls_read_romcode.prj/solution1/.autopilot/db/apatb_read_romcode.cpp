...
extern "C"
void read_romcode_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_read_romcode_hw(void* __xlx_apatb_param_romcode, void* __xlx_apatb_param_internal_bram, hls::sim::Byte<4> __xlx_apatb_param_length_r)
{
  ...
  port1.param = &__xlx_apatb_param_length_r;
  ...
  port2.param = { __xlx_apatb_param_romcode };
  port2.nbytes = { 8192 };
  port2.offset = {  };
  ...
  port3.param = { __xlx_apatb_param_internal_bram };
  port3.nbytes = { 8192 };
  port3.offset = {  };
  port3.hasWrite = { true };
