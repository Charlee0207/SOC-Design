...
using hls::sim::Byte;
extern "C" void read_romcode(Byte<4>*, int, Byte<4>*, int);
...
__xlx_internal_bram__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_internal_bram)[i]);
  ...
  // DUT call
  read_romcode(__xlx_romcode__tmp_vec.data(), __xlx_offset_byte_param_romcode, __xlx_internal_bram__tmp_vec.data(), __xlx_apatb_param_length_r);
